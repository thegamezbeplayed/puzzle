...
static const ObjectInstance BASE_SHAPE = {SHAPE_NONE,1,{[STATE_PLACED]=BEHAVIOR_SHAPE_PLACED,[STATE_CALCULATING]=BEHAVIOR_CALCULATE}};
...
static const BehaviorData room_behaviors[BEHAVIOR_COUNT] = {
  ...
  {BEHAVIOR_CALCULATE,true,BT_SEQUENCE,NULL,false,0,0,2, {BEHAVIOR_START_CALC,BEHAVIOR_MATCH_GRID}},
