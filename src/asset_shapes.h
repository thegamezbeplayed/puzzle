...
static sub_texture_t SHAPE_SPRITES[SHAPE_COUNT] = {
  ...
  { SHAPE_BLUE_STAR, 64, 60, 129, 384, 129, 120, 0, false, 0, 0, 129, 120, 0, 0, 0, 0, 0 },
  { SHAPE_BLUE_GEM, 64, 52, 777, 384, 129, 104, 0, false, 0, 0, 129, 104, 0, 0, 0, 0, 0 },
  { SHAPE_BLUE_HEART, 65, 59, 518, 384, 130, 118, 0, false, 0, 0, 130, 118, 0, 0, 0, 0, 0 },
};
