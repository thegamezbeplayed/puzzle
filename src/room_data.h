...
static const BehaviorData room_behaviors[BEHAVIOR_COUNT] = {
  ...
  //{BEHAVIOR_CAN_MOVE, false, BT_LEAF, LeafCheckMoves, false,0,0,0,{}},
  //{BEHAVIOR_CAN_SOLVE, false, BT_LEAF, LeafCheckSolutions, false,0,0,0,{}},
  //{BEHAVIOR_CHECK_MOVES ,true ,BT_SEQUENCE ,NULL ,true ,STATE_IDLE ,TURN_END ,2 ,{BEHAVIOR_CAN_MOVE ,BEHAVIOR_CAN_SOLVE}}
};
#endif
