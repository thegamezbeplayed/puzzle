...
static const ObjectInstance BASE_SHAPE = {SHAPE_NONE,1,{[STATE_PLACED]=BEHAVIOR_SHAPE_PLACED,[STATE_CALCULATING]=BEHAVIOR_CALCULATE,[STATE_IDLE]=BEHAVIOR_CHECK_TURN}};
static const TileInstance BASE_TILE = {BACKTILE_01,{[STATE_EMPTY]=BEHAVIOR_SOLVABLE_CHILD,[STATE_SPAWN]=BEHAVIOR_ACQUIRE_CHILD, [STATE_CALCULATING]=BEHAVIOR_END_TURN}};
...
static const BehaviorData room_behaviors[BEHAVIOR_COUNT] = {
  ...
  {BEHAVIOR_SCORE_TURN , false, BT_SEQUENCE,NULL,true,STATE_SCORE,TURN_SCORE,2,{BEHAVIOR_CHECK_OWNERS_STATE, BEHAVIOR_PROGRESS_WORLD_STATE}},
  {BEHAVIOR_END_TURN ,true,BT_SEQUENCE,NULL,false,0,0,1,{BEHAVIOR_SCORE_TURN}},
